...
![Player stats stored in memory](screenshots/player_stats.png)
...
![Example of Room](screenshots/rooms_example.png)

_rooms.py_


![Listing of characters in memory](screenshots/character_list.png)
...
![Function for moving between rooms](screenshots/move_between_rooms.png)


- Combat system including special rooms and boss battles. 


![function showing battle between two characters](screenshots/two_battle.png)
...
![function showing saving of information](screenshots/current_player_information.png)
...
![function showing creation of a room](screenshots/rooms_example.png)
...
![function showing battle between two characters](screenshots/enter_room.png)
...
![variable example](screenshots/variables.png)
...
![example of loop](screenshots/loops_and_branches.png)
